...
export const generateSandwichImage = async (ingredientsWithPortions: IIngredientWithPortion[]): Promise<string> => {
...
async function fillIngredientsData(
  ingredientsWithPortions: IIngredientWithPortion[],
): Promise<SandwichLayerIngredient[]> {
...
async function generateSandwichLayer(shape: string, ingredient: SandwichLayerIngredient): Promise<Buffer> {
