...
type BadgeVariant = 'warning' | 'success' | 'info';
...
interface UserCardProps {
  ...
  isActive: boolean;
  onLoginChild: () => void;
  onConvertChild?: (email: string) => Promise<ApiResult>;
  onResendInvite?: () => void;
...
const UserCard = ({
  ...
  // Reset the email form state when the user's email changes (during render, not in an effect).
