...
export const calculateLayerHeight = (
  ...
  viewportHeight: number = globalThis.window === undefined ? 0 : window.innerHeight,
): number | null => {
 ...
 */
export const useStableLayerHeight = (containerRef: RefObject<HTMLElement | null>): number | null => {
