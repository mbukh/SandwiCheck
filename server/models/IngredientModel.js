...
import { TYPES, SHAPES, DIETARY_PREFERENCES, PRODUCTS, isBreadType } from '../constants/ingredientsConstants.js';
...
const ingredientSchema = new Schema(
  {
    ...
    type: {
      ...
      enum: {
        ...
        message: `Role must be either ${[...Object.values(TYPES), ...Object.values(PRODUCTS)].join(', ')}`,
      },
      required: true,
    },
    shape: {
