...
import { DIETARY_PREFERENCES } from "../constants/ingredientsConstants.ts";
import {
    ROLES,
...
import { DAYS_OF_WEEK } from "../constants/daysOfWeek.ts";
...
function checkChildWithoutEmail(this: any) {
    return !this.isTetheredChild;
}

function validateDailyMenu(value: any) {
    const totalSandwiches = value.reduce((acc: any, day: any) => acc + day.quantity, 0);
